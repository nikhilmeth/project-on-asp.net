<%@ Page Title="Category" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="CustomTees.aspx.cs" Inherits="CustomTees" %>
...
<html lang="en">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="cssNew/jquery.miniColors.css" />
    ...
    <div class="container">
		<section id="typography">
		  <div class="page-header">
		    <h2 class="product-bit-title">Customize T-Shirt</h2>
		  </div>
				    ...
				    <div class="tab-pane" id="tab2">
				    	<div class="well">
				    		<div class="input-append">
							  <input id="text-string" type="text" placeholder="add text here..." enabled="enabled" style="color: black">
							...
							<div id="avatarlist">
                                ...
                                <img style="cursor:pointer;" class="img-polaroid" src="img/Manchester-United-Logo-PNG.png">
                                <img style="cursor:pointer;" class="img-polaroid" src="img/chelsea.png">
			      ...
			      <p>
			      	<table class="table">
			      		...
			      		<tr>
			      			...
			      			<td align="right"><strong>$24.47</strong></td>
			      		</tr>
			      	</table>			
			      </p>
                  <form runat="server">
                    <asp:Button ID="addToTheBag" runat="server" Text="Add to Cart"  class="btn btn-large btn-block btn-success" OnClick="addToTheBag_Click" />
                       </form>
		      </div>		      		       		   
		    </div>
